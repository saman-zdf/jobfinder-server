...
const getAllJobs = async (req, res) => {
  ...
  // skip() from mongoose will skip the number of jobs that has been specified and limit() from mongoose will determine how many item to show, basically set limitation of item to respond for the request
